...
func CloudIcon() templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<svg width=\"16\" height=\"16\" viewBox=\"0 0 16 16\" fill=\"currentColor\" xmlns=\"http://www.w3.org/2000/svg\" class=\"w-4 h-4\"><path d=\"M1 9.5C1 11.433 2.567 13 4.5 13H12C13.6569 13 15 11.6569 15 10C15 8.66283 14.1252 7.53 12.9166 7.14262C12.971 6.93756 13 6.72217 13 6.5C13 5.11929 11.8807 4 10.5 4C10.2274 4 9.96493 4.04364 9.71929 4.12432C9.18482 2.87521 7.94462 2 6.5 2C4.567 2 3 3.567 3 5.5C3 5.77356 3.03138 6.03979 3.09075 6.29529C1.85956 6.83748 1 8.06836 1 9.5Z\" fill=\"#0F172A\"></path></svg>")
